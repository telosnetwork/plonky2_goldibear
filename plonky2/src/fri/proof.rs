...
#[serde(bound = "")]
pub struct FriQueryStep<F: RichField + BinomiallyExtendable<D>, H: Hasher<F>, const D: usize> {
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct FriQueryRound<F: RichField + BinomiallyExtendable<D>, H: Hasher<F>, const D: usize> {
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct CompressedFriQueryRounds<F: RichField + BinomiallyExtendable<D>, H: Hasher<F>, const D: usize> {
    /// Query indices.
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct FriProof<F: RichField + BinomiallyExtendable<D>, H: Hasher<F>, const D: usize> {
...
#[derive(Serialize, Deserialize, Clone, Debug, Eq, PartialEq)]
#[serde(bound = "")]
pub struct CompressedFriProof<F: RichField + BinomiallyExtendable<D>, H: Hasher<F>, const D: usize> {
    /// A Merkle cap for each reduced polynomial in the commit phase.
    pub commit_phase_merkle_caps: Vec<MerkleCap<F, H>>,
...
impl<F: RichField + BinomiallyExtendable<D>, H: Hasher<F>, const D: usize> FriProof<F, H, D> {
...
impl<F: RichField + BinomiallyExtendable<D>, H: Hasher<F>, const D: usize> CompressedFriProof<F, H, D> {
...
#[derive(Debug)]
pub struct FriChallenges<F: RichField + BinomiallyExtendable<D>, const D: usize> {
