...
lazy_static! {
    pub static ref poseidon2_r0: Poseidon2<BabyBear, Poseidon2ExternalMatrixHL, DiffusionMatrixBabyBear, SPONGE_WIDTH, 7> = {
        Poseidon2::new(
            N_FULL_ROUNDS_TOTAL,
            EXTERNAL_CONSTANTS
...
impl<F: RichField> Permuter31R0 for F {
    fn permute(input: [Self; SPONGE_WIDTH]) -> [Self; SPONGE_WIDTH] {
        let mut res = input
...
impl<F: RichField> AlgebraicHasher<F, 8> for Poseidon2R0BabyBearHash {
    ...
    {
        panic!("Missing Poseidon2R0BabyBearGate");
...
mod tests {
    ...
    use p3_symmetric::Permutation;
    use crate::hash::poseidon2_risc0_babybear::{Permuter31R0, poseidon2_r0, Poseidon2R0BabyBearHash, SPONGE_WIDTH};
    use crate::plonk::circuit_builder::CircuitBuilder;
