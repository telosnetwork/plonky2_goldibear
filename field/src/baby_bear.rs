use crate::types::{Field, Field64, PrimeField, PrimeField32, Sample};
use crate::monty::{
...
pub fn exp_u64_by_squaring<AF: Field>(val: AF, power: u64) -> AF {
    let mut current = val;
...
pub fn exp_1725656503<AF: Field>(val: AF) -> AF {
...
impl FieldParameters for BabyBearParameters {
    fn exp_u64_generic<AF: Field>(val: AF, power: u64) -> AF {
        match power {
