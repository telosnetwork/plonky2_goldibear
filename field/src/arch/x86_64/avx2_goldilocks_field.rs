...
///
/// Ideally `Avx2Goldilocks` would wrap `__m256i`. Unfortunately, `__m256i` has an alignment of
/// 32B, which would preclude us from casting `[Goldilocks; 4]` (alignment 8B) to
/// `Avx2Goldilocks`. We need to ensure that `Avx2Goldilocks` has the same alignment as
/// `Goldilocks`. Thus we wrap `[Goldilocks; 4]` and use the `new` and `get` methods to
/// convert to and from `__m256i`.
#[derive(Copy, Clone)]
#[repr(transparent)]
pub struct Avx2Goldilocks(pub [Goldilocks; 4]);
...
impl Add<Self> for Avx2Goldilocks {
    type Output = Self;
    #[inline]
...
impl Add<Goldilocks> for Avx2Goldilocks {
    type Output = Self;
    #[inline]
...
impl Add<Avx2Goldilocks> for Goldilocks {
    type Output = Avx2Goldilocks;
    #[inline]
    fn add(self, rhs: Self::Output) -> Self::Output {
        Self::Output::from(self) + rhs
    }
}
impl AddAssign<Self> for Avx2Goldilocks {
    #[inline]
    fn add_assign(&mut self, rhs: Self) {
        *self = *self + rhs;
    }
}
impl AddAssign<Goldilocks> for Avx2Goldilocks {
    #[inline]
...
impl Default for Avx2Goldilocks {
    #[inline]
    fn default() -> Self {
        Self::zeros()
    }
...
impl Div<Goldilocks> for Avx2Goldilocks {
    type Output = Self;
...
impl DivAssign<Goldilocks> for Avx2Goldilocks {
...
impl From<Goldilocks> for Avx2Goldilocks {
    fn from(x: Goldilocks) -> Self {
        Self([x; 4])
    }
}

impl Mul<Self> for Avx2Goldilocks {
    type Output = Self;
    #[inline]
...
impl Mul<Goldilocks> for Avx2Goldilocks {
    type Output = Self;
    #[inline]
...
impl Mul<Avx2Goldilocks> for Goldilocks {
    type Output = Avx2Goldilocks;
    #[inline]
    fn mul(self, rhs: Avx2Goldilocks) -> Self::Output {
        Self::Output::from(self) * rhs
    }
}
impl MulAssign<Self> for Avx2Goldilocks {
    #[inline]
    fn mul_assign(&mut self, rhs: Self) {
        *self = *self * rhs;
    }
}
impl MulAssign<Goldilocks> for Avx2Goldilocks {
    #[inline]
...
impl Product for Avx2Goldilocks {
    #[inline]
...
unsafe impl PackedField for Avx2Goldilocks {
    const WIDTH: usize = 4;
    ...
    fn ones() -> Self{
        Self([Goldilocks::one();4])
    }

    fn twos() -> Self{
        Self([Goldilocks::two();4])
    }
...
impl Square for Avx2Goldilocks {
    #[inline]
    fn square(&self) -> Self {
...
impl Sub<Self> for Avx2Goldilocks {
    type Output = Self;
    #[inline]
...
impl Sub<Goldilocks> for Avx2Goldilocks {
    type Output = Self;
    #[inline]
...
impl Sub<Avx2Goldilocks> for Goldilocks {
    type Output = Avx2Goldilocks;
    #[inline]
    fn sub(self, rhs: Avx2Goldilocks) -> Self::Output {
        Self::Output::from(self) - rhs
    }
}
impl SubAssign<Self> for Avx2Goldilocks {
    #[inline]
    fn sub_assign(&mut self, rhs: Self) {
        *self = *self - rhs;
    }
}
impl SubAssign<Goldilocks> for Avx2Goldilocks {
    #[inline]
...
const SHIFTED_FIELD_ORDER: __m256i =
    unsafe { transmute([Goldilocks::ORDER_U64 ^ (i64::MIN as u64); 4]) };
const EPSILON: __m256i = unsafe { transmute([Goldilocks::ORDER_U64.wrapping_neg(); 4]) };
...
#[cfg(test)]
mod tests {
    use crate::arch::x86_64::avx2_goldilocks_field::Avx2Goldilocks;
    use p3_goldilocks::Goldilocks;
    use crate::ops::Square;
    use crate::packed::PackedField;
    ...
    fn test_vals_a() -> [Goldilocks; 4] {
        [
           Goldilocks::from_canonical_u64(14479013849828404771),
           Goldilocks::from_canonical_u64(9087029921428221768),
           Goldilocks::from_canonical_u64(2441288194761790662),
           Goldilocks::from_canonical_u64(5646033492608483824),
        ]
    }
    fn test_vals_b() -> [Goldilocks; 4] {
        [
           Goldilocks::from_canonical_u64(17891926589593242302),
           Goldilocks::from_canonical_u64(11009798273260028228),
           Goldilocks::from_canonical_u64(2028722748960791447),
           Goldilocks::from_canonical_u64(7929433601095175579),
        ]
    }
    ...
    fn test_add() {
        ...
        let packed_a = *Avx2Goldilocks::from_slice(&a_arr);
        let packed_b = *Avx2Goldilocks::from_slice(&b_arr);
    ...
    fn test_square() {
        ...
        let expected = a_arr.iter().map(|&a| AbstractField::square(&a));
        for (exp, &res) in expected.zip(arr_res) {
            assert_eq!(res, exp);
        }
    }
    ...
    fn test_interleave() {
        let in_a: [Goldilocks; 4] = [
           Goldilocks::from_canonical_u64(00),
           Goldilocks::from_canonical_u64(01),
           Goldilocks::from_canonical_u64(02),
           Goldilocks::from_canonical_u64(03),
        ];
        let in_b: [Goldilocks; 4] = [
           Goldilocks::from_canonical_u64(10),
           Goldilocks::from_canonical_u64(11),
           Goldilocks::from_canonical_u64(12),
        ...
        let packed_a = *Avx2Goldilocks::from_slice(&in_a);
        let packed_b = *Avx2Goldilocks::from_slice(&in_b);
        {
