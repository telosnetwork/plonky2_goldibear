use p3_field::{exp_1725656503, exp_u64_by_squaring, AbstractField, Field, PrimeField32};
use p3_monty_31::{
...
pub struct P3Risc0BabyBearParameters;

impl MontyParameters for P3Risc0BabyBearParameters {
...
impl PackedMontyParameters for P3Risc0BabyBearParameters {}

impl BarrettParameters for P3Risc0BabyBearParameters {}

impl FieldParameters for P3Risc0BabyBearParameters {
    ...
    const MONTY_GEN: P3Risc0BabyBear = P3Risc0BabyBear::new(31);
}

impl TwoAdicData for P3Risc0BabyBearParameters {
    const TWO_ADICITY: usize = 27;

    type ArrayLike = &'static [P3Risc0BabyBear];

    const TWO_ADIC_GENERATORS: Self::ArrayLike = &P3Risc0BabyBear::new_array([
    ...
    const ROOTS_8: Self::ArrayLike = &P3Risc0BabyBear::new_array([0x5ee99486, 0x67055c21, 0xc9ea3ba]);
    const INV_ROOTS_8: Self::ArrayLike = &P3Risc0BabyBear::new_array([0x6b615c47, 0x10faa3e0, 0x19166b7b]);

    const ROOTS_16: Self::ArrayLike = &P3Risc0BabyBear::new_array([
        0xbb4c4e4, 0x5ee99486, 0x4b49e08, 0x67055c21, 0x5376917a, 0xc9ea3ba, 0x563112a7,
    ]);
    const INV_ROOTS_16: Self::ArrayLike = &P3Risc0BabyBear::new_array([
        0x21ceed5a, 0x6b615c47, 0x24896e87, 0x10faa3e0, 0x734b61f9, 0x19166b7b, 0x6c4b3b1d,
    ]);
}

impl BinomialExtensionData<4> for P3Risc0BabyBearParameters {
    //The binomial used to extend babybear in Risc0 is x^4 + 11 instead of x^4 - 11 used in Plonky3 :-(
    const W: P3Risc0BabyBear = P3Risc0BabyBear::new(P3Risc0BabyBear::ORDER_U32 - 11);
    const DTH_ROOT: P3Risc0BabyBear = P3Risc0BabyBear::new(1728404513);
    //TODO Update EXT Generator!!!
    const EXT_GENERATOR: [P3Risc0BabyBear; 4] = P3Risc0BabyBear::new_array([8, 1, 0, 0]);
...
impl BinomialExtensionData<5> for P3Risc0BabyBearParameters {
    const W: P3Risc0BabyBear = P3Risc0BabyBear::new(2);
    const DTH_ROOT: P3Risc0BabyBear = P3Risc0BabyBear::new(815036133);
    const EXT_GENERATOR: [P3Risc0BabyBear; 5] = P3Risc0BabyBear::new_array([8, 1, 0, 0, 0]);
    const EXT_TWO_ADICITY: usize = 27;

    type ArrayLike = [[P3Risc0BabyBear; 5]; 0];
    const TWO_ADIC_EXTENSION_GENERATORS: Self::ArrayLike = [];
}
...
mod tests {
    ...
    fn test_baby_bear_two_adicity_generators() {
        let base = P3Risc0BabyBear::from_canonical_u32(0x1a427a41);
        for bits in 0..=P3Risc0BabyBear::TWO_ADICITY {
            assert_eq!(
                P3Risc0BabyBear::two_adic_generator(bits),
                base.exp_power_of_2(P3Risc0BabyBear::TWO_ADICITY - bits)
            );
        }
    }
    ...
    fn test_to_babybear_array() {
        ...
        assert_eq!(
            P3Risc0BabyBear::new_array(range_array),
    ...
    test_field!(crate::p3_risc0_baby_bear::field::P3Risc0BabyBear);
    test_two_adic_field!(crate::p3_risc0_baby_bear::field::P3Risc0BabyBear);

    test_field_dft!(radix2dit, crate::p3_risc0_baby_bear::field::P3Risc0BabyBear, p3_dft::Radix2Dit<_>);
    test_field_dft!(bowers, crate::p3_risc0_baby_bear::field::P3Risc0BabyBear, p3_dft::Radix2Bowers);
    test_field_dft!(parallel, crate::p3_risc0_baby_bear::field::P3Risc0BabyBear, p3_dft::Radix2DitParallel);
    test_field_dft!(
        recur_dft,
        crate::p3_risc0_baby_bear::field::P3Risc0BabyBear,
...
mod test_quartic_extension {
    ...
    use crate::p3_risc0_baby_bear::field::P3Risc0BabyBear;
